...
import 'package:shabakahub2025/presentation/widgets/drawer_nav/app_drawer.dart'; // Import AppDrawer
                ...
                children: controller.categories.map((category) {
                  return CategoryCard(
                    ...
                    onTap: () { // onTap callback for CategoryCard
                      Get.toNamed(
                        Routes.COURSES, // Navigate to a new route
                        parameters: {'categoryId': category.id, 'categoryName': category.name}, // Pass category ID and name
                      );
                    },
                  );
                }).toList(),
